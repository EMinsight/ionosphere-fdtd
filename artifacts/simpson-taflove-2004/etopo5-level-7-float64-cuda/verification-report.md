...
생성 시각: 2026-08-03T12:57:52+09:00
...
|---|---:|---:|---:|---:|
| A–B | 0.387 dB/Mm | 1.747 dB/Mm | ±0.5 dB/Mm | 실패 |
| A′–B′ | 0.590 dB/Mm | 2.020 dB/Mm | ±1.0 dB/Mm | 실패 |

## 전체 지표

| 지표 | 값 |
|---|---:|
| `path_ab_mean_absolute_error_db_per_mm` | 0.387016 |
| `path_apbp_mean_absolute_error_db_per_mm` | 0.589615 |
| `path_ab_maximum_absolute_error_db_per_mm` | 1.74652 |
| `path_apbp_maximum_absolute_error_db_per_mm` | 2.0198 |
| `path_ab_maximum_error_frequency_hz` | 498.454 |
| `path_apbp_maximum_error_frequency_hz` | 447.591 |
| `path_ab_maximum_residual_db_per_mm` | -1.74652 |
| `path_apbp_maximum_residual_db_per_mm` | 2.0198 |
| `A_negative_peak_step` | 7546 |
| `A_negative_peak_uv_m` | -1.1985 |
| `A′_negative_peak_step` | 7589 |
| `A′_negative_peak_uv_m` | -1.25945 |
| `B_negative_peak_step` | 14494 |
| `B_negative_peak_uv_m` | -0.421955 |
| `B′_negative_peak_step` | 14494 |
| `B′_negative_peak_uv_m` | -0.421955 |
| `quarter_east_west_relative_rms` | 0.0821975 |
| `half_east_west_relative_rms` | 6.9502e-16 |
...
| `path_ab_phase_velocity_mean_absolute_error_fraction_c` | 0.0197205 |
| `path_apbp_phase_velocity_mean_absolute_error_fraction_c` | 0.0146413 |
| `path_ab_phase_velocity_maximum_absolute_error_fraction_c` | 0.0829706 |
| `path_apbp_phase_velocity_maximum_absolute_error_fraction_c` | 0.0965013 |
| `A_dft_cutoff_step` | 22922 |
| `A′_dft_cutoff_step` | 23286 |
